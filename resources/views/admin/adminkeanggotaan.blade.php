    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center">
        ...
        <div class="flex text-right justify-end items-center space-x-2 py-5">
          <a href="/admingaleri"
            class="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium">Kelola galeri</a>
          <a href="/adminartikel"
            class="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium">Kelola artikel</a>
          <a href="/adminkeanggotaan" class="text-blue-600 border-b-2 border-blue-600 pb-1 px-3 py-2  text-sm font-medium">Kelola keanggotaan</a>
          @if (Auth::user() != null)
        <a href="/logout"
        class="bg-red-500 hover:bg-red-600 text-white px-3 py-2 rounded-md text-sm font-medium">Logout</a>
      @endif
        </div>
      </div>
    </div>
    ...
    @endif
      ...
      @endif
        ...
        <td class="p-3 text-center">
          ...
          class="relative bg-red-500 text-white rounded-md px-1 py-1 hover:bg-red-600">Hapus</a>
        </td>
        @endif
          </tr>
        @endif
    ...
    <section class="bg-white rounded shadow p-6">
      ...
      @endif
        ...
        <td class="p-3 text-center">
          ...
          class="bg-blue-600 rounded-md px-2 py-1 text-white hover:bg-blue-700">Edit</a>
          <a href="/deleteAnggota/{{ $data->id }}"
          class="bg-red-500 text-white rounded-md px-1 py-1 hover:bg-red-600">Hapus</a>
        </td>
        @endif
          </tr>
        @endif
